...
local function run(msg, matches)
  if matches[1]:lower() == 'shadow' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "shadow" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) ([Ss]hadow)",-- Put everything you like :)
		"^[!/]([Ss]hadow)"-- Put everything you like :)
    }, 
  run = run
}
